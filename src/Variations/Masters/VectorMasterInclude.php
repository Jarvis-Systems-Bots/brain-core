...
#[Purpose('Defines execution guidelines for VectorMaster agent, focusing on direct MCP tool execution for vector memory operations.')]
class VectorMasterInclude extends IncludeArchetype
{
    /**
