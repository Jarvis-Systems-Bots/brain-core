...
#[Purpose('Specialized master for in-depth codebase exploration and analysis. Utilizes Glob and Grep tools to discover files, search content, and map architecture. Implements a three-tier thoroughness system (quick, medium, very thorough) to tailor exploration depth. Follows a multi-step workflow: parse query, check memory, execute Glob/Grep, read files, synthesize insights. Enforces iron rules for tool usage, performance optimization, and compliance with user specifications. Designed for efficient, accurate, and comprehensive codebase understanding.')]
class ExploreMasterInclude extends IncludeArchetype
{
    /**
