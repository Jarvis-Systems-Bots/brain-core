...
class WebBasicResearchInclude extends IncludeArchetype
{
    /**
    ...
    protected function handle(): void
    {
        $this->guideline('web-search')
            ...
            ->example()
                ...
                ->phase('step-2', 'Extract content from top 3-5 URLs')
                ->phase('step-3', 'Validate and synthesize findings');
        ...
        $this->guideline('tools')
            ->text('Web research tools by context.')
            ->example('WebSearch - general web queries')
            ->example('WebFetch - extract content from specific URL')
            ->example('Context7 - library/package documentation')
            ->example('search-docs MCP - Laravel ecosystem docs');
