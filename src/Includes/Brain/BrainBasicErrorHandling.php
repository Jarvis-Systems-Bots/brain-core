...
class BrainBasicErrorHandling extends IncludeArchetype
{
    /**
    ...
    protected function handle(): void
    {
        $this->guideline('error-delegation-failed')
            ...
            ->example('Reassign task to Architect Agent for redistribution')->key('response')
        ...
        $this->guideline('escalation-policy')
            ...
            ->example('Critical errors: Suspend operation, restore state, notify Architect Agent')->key('critical')
